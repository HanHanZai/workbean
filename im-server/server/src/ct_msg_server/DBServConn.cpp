...
void CDBServConn::_HandleMsgData(CImPdu *pPdu)
{
    ...
    if(msg.session_type()==::IM::BaseDefine::SESSION_TYPE_GROUP)
    {
...
void CDBServConn::_HandleGetDeviceTokenResponse(CImPdu *pPdu)
{
    ...
    if (msg_type == IM::BaseDefine::MSG_TYPE_TEXT)
    {
        //msg_data =
        /*
        char* msg_out = NULL;
    ...
    if(msg2.session_type()==::IM::BaseDefine::SESSION_TYPE_GROUP)
    {
